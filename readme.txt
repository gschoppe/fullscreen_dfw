...
Tags: editor, tinyMCE, distraction free, distraction-free, dfw, full width, fullwidth, fullscreen, expand, enlarge, big, media queries
...
Fullscreen DFW allows you to use the complete width of your browser window for editing in DFW mode.
Simply hit the DFW button, in the upper right corner of the editor, and the editor will expand to fill the width of your window.

---
Learn More at: **[http://gschoppe.com/fullscreen-dfw](http://gschoppe.com/fullscreen-dfw)**
---
...
1. Search for 'Fullscreen Distraction-Free Writing'
1. Click Install
1. Activate Fullscreen Distraction-Free Writing from your Plugins page.

= From WordPress.org =

1. Download Fullscreen Distraction-Free Writing.
1. Upload the 'fullscreen_dfw' directory to your '/wp-content/plugins/' directory, using your favorite method (ftp, sftp, scp, etc...)
1. Activate the Fullscreen Distraction-Free Writing plugin from your Plugins page.

= Once Activated =

1. Edit or Create a Post, Page, or Custom Post Type
1. Click the DFW button on the right hand side of the visual editor's toolbar
1. Click the DFW button again, when you want to return to windowed mode.

== Compatibility ==
Fullscreen Distraction-Free Writing has been fully tested in the following browsers:
...
== Website ==
[http://gschoppe.com/fullscreen-dfw](http://gschoppe.com/fullscreen-dfw)
...
A. Fullscreen Distraction-Free Writing does nothing until you click the DFW button in the WordPress editor.

= Q. Why would you want this? =
A. I often design sites to use a max content area size of 1200px.  On a 1440x900 laptop, that width cannot
...
= Q. Can I integrate Fullscreen DFW in my theme/plugin? =
...
1. Where to find the DFW button

2. What the full width editor looks like
